package com.muchi.news.data.remote.moshiFactories;
...
public final class MyStandardJsonAdapters {
    ...
    static final JsonAdapter<Byte> BYTE_JSON_ADAPTER = new JsonAdapter<Byte>() {
        @Override public Byte fromJson(@NotNull JsonReader reader) throws IOException {
    ...
    static final JsonAdapter<Float> FLOAT_JSON_ADAPTER = new JsonAdapter<Float>() {
        ...
        @Override public void toJson(@NotNull JsonWriter writer, Float value) throws IOException {
    ...
    static final JsonAdapter<Short> SHORT_JSON_ADAPTER = new JsonAdapter<Short>() {
        @Override public Short fromJson(@NotNull JsonReader reader) throws IOException {
    ...
    static final class ObjectJsonAdapter extends JsonAdapter<Object> {
        ...
        @Override public void toJson(@NotNull JsonWriter writer, Object value) throws IOException {
